<template>
  <div class="app-container">
    ...
    <div>
      ...
      <a href="https://panjiachen.github.io/vue-element-admin-site/feature/component/excel.html" target="_blank" style="margin-left:15px;"><el-tag type="info">公众号 商户号 设备号 付款银行 支付接口信息 ..</el-tag></a>
    </div>
    <el-table v-loading="listLoading" :data="list" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column label="商品描述" width="255" align="center">
        <template slot-scope="scope">
          <el-tag>{{ scope.row.productName }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="商品详情" width="85" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="数量" width="135" align="center">
        <template>
          2019-10-16 12:49
        </template>
      </el-table-column>
      ...
      <el-table-column label="货币类型" width="50" align="center">
        <template slot-scope="scope">
          {{ scope.row.userNum }}
        </template>
      </el-table-column>
      ...
      <el-table-column label="交易属性" width="80" align="center">
        <template slot-scope="scope">
          {{ scope.row.userName }}
        </template>
      </el-table-column>
      <el-table-column label="交易状态" width="175" align="center">
        <template slot-scope="scope">
