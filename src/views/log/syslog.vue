<template>
  <div class="app-container">
    ...
    <el-table v-loading="listLoading" :data="list" element-loading-text="拼命加载中" border fit highlight-current-row>
      ...
      <el-table-column label="标志" width="110">
        <template slot-scope="scope">
          <!--{{ scope.row.orderId }}-->
          {{ scope.row.orderId }}
        </template>
      ...
      <el-table-column label="内容" width="85" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="日志级别" width="110" align="center">
        <template>
          2019-10-16 12:49
        </template>
      </el-table-column>
      ...
      <el-table-column label="UA" width="50" align="center">
        <template slot-scope="scope">
          {{ scope.row.userNum }}
        </template>
      </el-table-column>
      <el-table-column label="browser" width="90" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column label="转换后地理位置" width="175" align="center">
        <template slot-scope="scope">
          {{ scope.row.userCardId }}
        </template>
      </el-table-column>
      <el-table-column label="经纬度" width="115" align="center">
        <template slot-scope="scope">
          {{ scope.row.userPhone }}
        </template>
      </el-table-column>
